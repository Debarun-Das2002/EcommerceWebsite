...
function Login(){
  ...
  async  function handleSubmit(){
       ...
       .then((req)=>{
            ...
            if(req.data.token){
                 Cookies.setItem('token',req.data.token,{expires: 14,secure: true})
                 Cookies.setItem('role',req.data.role,{expires: 14,secure: true})
                 Cookies.setItem('id',req.data.id,{expires: 14,secure: true})
                 Navigate('/home');
